...
#define MAX_LINE_LEN        40960 //4096
#define MAX_LINES_COUNT     100   //200
...
- (void) trace:(NSString*)msg
{
    ...
    {
        int skippedNum = [msg length] - MAX_LINE_LEN - 4;
        msg = [NSString stringWithFormat:@"%@ [...skiped (%d) characters...]", [msg substringToIndex:MAX_LINE_LEN - 4] , skippedNum ];
    }
    traceCount++;
